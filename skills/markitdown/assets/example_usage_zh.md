...
md = MarkItDown(
    ...
    llm_prompt="描述这张科学幻灯片，重点关注数据和关键发现"
)
...
def safe_convert(filepath):
    ...
    try:
        ...
        logger.error(f"转换 {filepath} 时出现意外错误: {e}")
        return False
